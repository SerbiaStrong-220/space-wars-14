...
public sealed class GameTopMenuBarUIController : UIController
{
    ...
    [Dependency] private readonly PartyUIController _party = default!; // SS220_SpaceWars party
    ...
    public void UnloadButtons()
    {
        ...
        _party.UnloadButton(); // SS220_SpaceWars party
    }
    ...
    public void LoadButtons()
    {
        ...
        _sandbox.LoadButton();
        _emotes.LoadButton();
        _party.LoadButton(); // SS220_SpaceWars party
    }
}
